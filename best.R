best <- function(state, outcome) { 
  ...
  ## Returns the Hospital Name in that state with lowest 30-day death 
  ...
  best_hospitals <- data[data[,header_name] == min_rate,] 
  hospital_names <- sort(best_hospitals[,"Hospital.Name"]) 
